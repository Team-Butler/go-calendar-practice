...
func (sq *ScheduleQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, schedule.UserTable, schedule.UserPrimaryKey...),
		)
...
func (sq *ScheduleQuery) sqlAll(ctx context.Context) ([]*Schedule, error) {
	...
	if query := sq.withUser; query != nil {
		...
		ids := make(map[int]*Schedule, len(nodes))
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(schedule.UserPrimaryKey[1], fks...))
			},
